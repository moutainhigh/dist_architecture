...
import com.xpay.middleware.leaf.snowflake.exception.CheckLastTimeException;
...
public class SnowflakeZookeeperHolder {
    ...
    public SnowflakeZookeeperHolder(String ip, String port, String connectionString, String leafName) {
        ...
        this.propPath = System.getProperty("java.io.tmpdir") + File.separator + this.leafName + "/leafconf/{port}/workerID.properties";
        this.pathForever = "/snowflake/" + this.leafName + "/forever";
    }
