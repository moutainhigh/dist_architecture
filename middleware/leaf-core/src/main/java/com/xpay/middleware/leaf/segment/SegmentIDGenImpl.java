...
import com.xpay.middleware.leaf.segment.model.Segment;
import com.xpay.middleware.leaf.segment.model.SegmentBuffer;
...
public class SegmentIDGenImpl implements IDGen {
    ...
    public void addSegment(String key, int step, Long maxId){
        if(cache.containsKey(key)) {
            return;
        }

        if(maxId == null){
            maxId = Long.valueOf(step);
        }else if(step > maxId){
            throw new RuntimeException("step cannot bigger than maxId");
        }
