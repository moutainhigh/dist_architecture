 ...
 */
public interface AccountSubProcessManageFacade {
     ...
     * @throws BizException .
     */
    PageResult<List<AccountSubProcessPending>> listProcessPendingPage(Map<String, Object> paramMap, PageParam pageParam, boolean inHistory) throws BizException;
     ...
     * @throws BizException .
     */
    AccountSubProcessPending getProcessPendingById(Long id, boolean inHistory) throws BizException;
     ...
     * @throws BizException .
     */
    PageResult<List<AccountSubProcessResult>> listProcessResultPage(Map<String, Object> paramMap, PageParam pageParam, boolean inHistory) throws BizException;
     ...
     * @throws BizException .
     */
    AccountSubProcessResult getProcessResultById(Long id, boolean inHistory) throws BizException;
     ...
     * @throws BizException .
     */
    PageResult<List<AccountSubProcessDetail>> listProcessDetailPage(Map<String, Object> paramMap, PageParam pageParam, boolean inHistory) throws BizException;
     ...
     * @throws BizException .
     */
    AccountSubProcessDetail getProcessDetailById(Long id, boolean inHistory) throws BizException;
