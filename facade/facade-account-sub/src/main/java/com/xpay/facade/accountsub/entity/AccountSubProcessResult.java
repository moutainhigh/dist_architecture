 ...
 * 子商户账务处理结果表
 */
public class AccountSubProcessResult implements Serializable {
     ...
     * @return .
     */
    public static AccountSubProcessResult newFromHistory(AccountSubProcessResultHistory history) {
        if (history == null) {
            return null;
        } else {
            AccountSubProcessResult result = new AccountSubProcessResult();
