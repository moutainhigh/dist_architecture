...
public class AccountTransitProcessDto implements Serializable {
    ...
    /**
     * 需要处理的是的哪种账户金额
     * {@link AccountTransitAmountTypeEnum}
     */
     ...
     * 账务扣款记录(账务内部逻辑处理时使用)
     */
    private AccountTransitProcessDetailDto debitDetailDto = null;
    ...
    public AccountTransitProcessDetailDto getDebitDetailDto() {
        return debitDetailDto;
    }

    public void setDebitDetailDto(AccountTransitProcessDetailDto debitDetailDto) {
