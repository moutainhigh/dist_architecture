 ...
 * 在途账户待账务处理表
 */
public class AccountTransitProcessPending implements Serializable {
     ...
     * @return .
     */
    public static AccountTransitProcessPending newFromHistory(AccountTransitProcessPendingHistory history) {
        if (history == null) {
            return null;
        } else {
            AccountTransitProcessPending pending = new AccountTransitProcessPending();
