 ...
 * 主商户账务处理结果表
 */
public class AccountMchProcessResult implements Serializable {
     ...
     * @return .
     */
    public static AccountMchProcessResult newFromHistory(AccountMchProcessResultHistory history) {
        if (history == null) {
            return null;
        } else {
            AccountMchProcessResult result = new AccountMchProcessResult();
