 ...
 */
public interface AccountMchProcessManageFacade {
    /**
     * 查询未处理的待账务处理记录id
     *
     ...
     * @return .
     */
    PageResult<List<AccountMchProcessPending>> listProcessPendingPage(Map<String, Object> paramMap, PageParam pageParam, boolean inHistory) throws BizException;
     ...
     * @return .
     */
    AccountMchProcessPending getProcessPendingById(Long id, boolean inHistory) throws BizException;
     ...
     * @return
     */
    PageResult<List<AccountMchProcessResult>> listProcessResultPage(Map<String, Object> paramMap, PageParam pageParam, boolean inHistory) throws BizException;
     ...
     * @return .
     */
    AccountMchProcessResult getProcessResultById(Long id, boolean inHistory) throws BizException;
     ...
     * @return .
     */
    PageResult<List<AccountMchProcessDetail>> listProcessDetailPage(Map<String, Object> paramMap, PageParam pageParam, boolean inHistory) throws BizException;
     ...
     * @return .
     */
    AccountMchProcessDetail getProcessDetailById(Long id, boolean inHistory) throws BizException;
