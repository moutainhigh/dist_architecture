 ...
 * 主商户账务处理明细表
 */
public class AccountMchProcessDetail implements Serializable {
     ...
     * @return .
     */
    public static AccountMchProcessDetail newFromHistory(AccountMchProcessDetailHistory history) {
        if (history == null) {
            return null;
        } else {
