 ...
 * Description:
 */
public class AccountTransitProcessDetailQueryVO implements Serializable {
    private String accountProcessNo; //账务处理流水号
    private String merchantNo;      //商户编号
    private String trxNo;           //平台流水号
    private Integer processType;    //账务处理类型 com.xpay.common.statics.enums.account.AccountProcessTypeEnum
