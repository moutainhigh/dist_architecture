...
import com.xpay.facade.accountsub.entity.AccountSubCommonUnique;
...
@Repository
public class AccountSubProcessDetailDao extends MyBatisDao<AccountSubProcessDetail, Long> {
    @Autowired
    private AccountSubCommonUniqueDao accountSubCommonUniqueDao;

    public void uniqueInsert(AccountSubProcessDetail accountDetail) {
     ...
     * @return .
     */
    public AccountSubProcessDetailDto getDebitDetailDtoByMchNoAndTrxNo(String merchantNo, String trxNo) {
