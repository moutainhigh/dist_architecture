CREATE TABLE `tbl_account_transit`
(
    ...
    `TRANSIT_AMOUNT` decimal(18, 2) unsigned NOT NULL DEFAULT '0.00' COMMENT '在途余额',
    PRIMARY KEY (`ID`),
    UNIQUE KEY `UK_MERCHANT_NO` (`MERCHANT_NO`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4 COMMENT ='在途账户表';

CREATE TABLE `tbl_account_transit_common_unique`
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='在途账户账务唯一约束表';

CREATE TABLE `tbl_account_transit_process_detail`
(
    `ID`                   bigint(20) unsigned     NOT NULL AUTO_INCREMENT COMMENT '自增主键',
    ...
    `ALTER_TRANSIT_AMOUNT` decimal(18, 2)          NOT NULL DEFAULT '0.00' COMMENT '变动在途余额',
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='在途账户账务处理明细表';

CREATE TABLE `tbl_account_transit_process_detail_history`
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='在途账户账务处理明细归档表'
...
CREATE TABLE `tbl_account_transit_process_pending`
(
    `ID`                 bigint(20) unsigned  NOT NULL AUTO_INCREMENT COMMENT '自增主键',
    `CREATE_TIME`        datetime             NOT NULL COMMENT '创建时间',
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='在途账户待账务处理表';

CREATE TABLE `tbl_account_transit_process_pending_history`
(
    `ID`                 bigint(20) unsigned  NOT NULL COMMENT '自增主键',
    `CREATE_TIME`        datetime             NOT NULL COMMENT '创建时间',
    `VERSION`            smallint(3) unsigned NOT NULL DEFAULT '0' COMMENT '版本号',
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='在途账户待账务处理归档表'
    /*!50100 PARTITION BY RANGE (to_days(CREATE_TIME))
    (PARTITION p201906 VALUES LESS THAN (737606) ENGINE = InnoDB,
    PARTITION p201907 VALUES LESS THAN (737637) ENGINE = InnoDB,
    PARTITION p201908 VALUES LESS THAN (737668) ENGINE = InnoDB,
...
CREATE TABLE `tbl_account_transit_process_result`
(
    `ID`                 bigint(20) unsigned  NOT NULL AUTO_INCREMENT COMMENT '自增主键',
    `VERSION`            smallint(3) unsigned NOT NULL DEFAULT '0' COMMENT '版本号',
    `CREATE_TIME`        datetime             NOT NULL COMMENT '创建时间',
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='在途账户账务处理结果表';

CREATE TABLE `tbl_account_transit_process_result_history`
(
    `ID`                 bigint(20) unsigned  NOT NULL AUTO_INCREMENT COMMENT '自增主键',
    `VERSION`            smallint(3) unsigned NOT NULL DEFAULT '0' COMMENT '版本号',
    `CREATE_TIME`        datetime             NOT NULL COMMENT '创建时间',
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='在途账户账务处理结果归档表'
    /*!50100 PARTITION BY RANGE (to_days(CREATE_TIME))
    (PARTITION p201906 VALUES LESS THAN (737606) ENGINE = InnoDB,
    PARTITION p201907 VALUES LESS THAN (737637) ENGINE = InnoDB,
    PARTITION p201908 VALUES LESS THAN (737668) ENGINE = InnoDB,
