...
import com.xpay.facade.accounttransit.entity.AccountTransitCommonUnique;
...
@Repository
public class AccountTransitProcessDetailDao extends MyBatisDao<AccountTransitProcessDetail, Long> {
    @Autowired
    private AccountTransitCommonUniqueDao accountTransitCommonUniqueDao;

    public void uniqueInsert(AccountTransitProcessDetail accountDetail) {
        ...
        AccountTransitCommonUnique unique = new AccountTransitCommonUnique();
        unique.setCreateTime(accountDetail.getCreateTime());
        unique.setUniqueKey(MD5Util.getMD5Hex(sb.toString()));
        accountTransitCommonUniqueDao.insert(unique);
     ...
     * @return .
     */
    public AccountTransitProcessDetailDto getDebitDetailDtoByMchNoAndTrxNo(String merchantNo, String trxNo) {
